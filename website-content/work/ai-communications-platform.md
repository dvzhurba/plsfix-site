...
role: Product Lead, Communications & AI/ML — Avito
dates: 2024–2026
summary: Led the shift of communications at Avito (60M+ users) from batch messaging to an ML-driven growth system, and authored the board-approved case to scale it.
...
outcome: Billions of messages a month; a 5% incremental lift in buyers on Android against a global control group; a 1.5x annual revenue uplift from the ML/GenAI stack.
links:
