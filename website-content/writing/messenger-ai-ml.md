...
date: 2026-06-25
summary: "On a marketplace the messenger is the conversion engine, not a chat feature — every buyer–seller conversation is a near-deal. A practitioner's account of the AI/ML behind it: intent and inbox ranking, suggested replies, price and negotiation, the agreement signal that stands in for off-platform deals, generative assistants, and the trust layer underneath."
publication: Self
tags: [ai, ml, communications, marketplace, messaging, nlp]
featured: false
---

The messenger is the conversion engine of a marketplace — the word here meaning the whole family of platforms where strangers transact, from transactional e-commerce, where the deal closes on-platform, to classifieds, where it usually closes in person. Search and recommendations decide what a buyer sees; the chat is where the deal is actually made or lost. Every conversation is a near-deal, which is why the surface needs the same rigour as search ranking — and why, at the classifieds end of that spectrum, it carries one problem ranking does not: the sale closes off-platform, so the system often cannot observe whether it won.
